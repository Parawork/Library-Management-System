...
public class Serialization{
    public static void saveUser(HashMap<Integer,User> obj) throws Exception {
    ...
    public static void saveBook(HashMap<Integer,Book> obj) throws Exception {
        // Create FileOutputStream to write object data to a file
    ...
    public static void saveLibrarian(HashMap<Integer,Librarian> obj) throws Exception {
        // Create FileOutputStream to write object data to a file
